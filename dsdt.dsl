 ...
 *
 * Disassembly of ./dsdt.aml, Mon Jun 24 11:06:46 2019
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000AF79 (44921)
 *     Revision         0x02
 *     Checksum         0xE1
 *     OEM ID           "INTEL "
 *     OEM Table ID     "EDK2    "
                      ...
                      Device (TCS0)
          {
              ...
              Name (_DSD, Package ()
              {
                  ToUUID("daffd814-6eba-4d8c-8a91-bc9bbf4aa301"), Package () {
                      Package (2) {"compatible", "syna,rmi4-i2c"},
                      Package (2) {"interrupts", 12},
...
*/
    ...
    Scope (_SB.I2C1)
    {
        ...
        Device (ACL0)
        {
            Name (_HID, "ADX3450")  // _HID: Hardware ID
            Name (_CID, "PRP0001")  // _CID: Compatible ID
            Name (_DDN, "Analog Devices ADXL345 3-axis accelerometer")  // _DDN: DOS Device Name
            Name (_CRS, ResourceTemplate ()  // _CRS: Current Resource Settings
            {
