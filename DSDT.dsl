 ...
 *
 * Disassembly of ./DSDT.dat, Sat Jun 22 20:45:57 2019
 *
 ...
 */
DefinitionBlock ("", "DSDT", 2, "INTEL ", "EDK2    ", 0x00000005)
{
    /*
        ...
        Device (I2C6)
        {
            ...
            Device (TCS0)
            {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Name (ABUF, ResourceTemplate ()
                    {
                        I2cSerialBusV2 (0x0020, ControllerInitiated, 0x0019F0A0,
                            AddressingMode7Bit, "\\_SB.I2C6",
                            0x00, ResourceConsumer, , Exclusive,
                            )
                        Interrupt (ResourceConsumer, Level, ActiveHigh, Exclusive, ,, )
    ...
    Scope (_SB.I2C1)
    {
        Device (SMFG)
        {
            Name (_HID, "BQF27541") 
            Name (_CID, "PRP0001") 
            Name (_DDN, "Fuel Gauge Controller")  
        ...
        Device (ACL0) {
            ...
            Name (_CRS, ResourceTemplate () {
                I2cSerialBusV2 (
                    ...
                    400000,              // Bus speed
                    AddressingMode7Bit,
                    "\\_SB.I2C1",   // Link to ACPI I2C host controller
                    0
                )
            })
